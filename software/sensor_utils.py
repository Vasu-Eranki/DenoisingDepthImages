    ...
    if(z=="Yes"):
        ...
        while(RGB_counter<27):
            ...
            while count<counter:
                ...
                count+=1; 
                if(count==30 and acquisition_flag==False):
                    count = 0
                ...
                if(acquisition_flag):
                    ...
                    break
            color_images_across_colors.append(np.mean(zerocolor_image,axis=0))## 540x640x480x3
            depth_images_across_colors.append(np.mean(zerodepth_image,axis=0)) ## 540x640x480
            L[0]="X"
            RGB_counter+=1
            pbar.update(1)
    else:
